...
class Episode2State extends FlxState
{
	override function create()
	{
		...
		var episode = new FlxSprite(FlxG.width / 2 - 250 - 108 - 24, FlxG.height / 2 - 98 - 16).loadGraphic("assets/images/episodew.png", true, 250, 98);
		...
		var space = new FlxSprite(FlxG.width / 2 - 104, FlxG.height / 2 + 16).loadGraphic("assets/images/last/space.png", true, 208, 98);
		...
		{
			FlxG.camera.fade(FlxColor.BLACK, 0.4, false, nextState);
		});
	}
